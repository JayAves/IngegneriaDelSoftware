...
public class BuildingCard extends Card{
	...
	private final ResourceOld woodCost;
	private final ResourceOld stoneCost;
	private final int productionForce;
	
	public BuildingCard(String name, Period period, CardType type,ResourceOld stoneCost, ResourceOld woodCost, int productionForce) {
